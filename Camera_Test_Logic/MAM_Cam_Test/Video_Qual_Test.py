...
def get_contrastval(frame):
    ...
    cv2.putText(frame, "{:.2f}".format(cnstr) + "%", (250, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.8,
                (0, 255, 255), 2)
...
def main(fps, latency):
    ...
    while True:
        ...
        cv2.putText(frame, "{}{:.2f}".format("FPS", fps), (350, 50),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)
        cv2.putText(frame, "{}{:.2f}".format("Latency", latency), (350, 70),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)
